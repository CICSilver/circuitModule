...
namespace
{
		...
		OpticalSvg& svg)
	{
		...
		int maxCorridorCount = AssignScopedOverlapLaneIndices(routePlanList);
		...
		int refinedCorridorCount = AssignScopedOverlapLaneIndices(routePlanList);
		if (refinedCorridorCount > maxCorridorCount)
		{
			maxCorridorCount = refinedCorridorCount;
		}
		AssignScopedVerticalLaneIndices(routePlanList);
		...
		AssignScopedOverlapLaneIndices(routePlanList);
		AssignScopedVerticalLaneIndices(routePlanList);
