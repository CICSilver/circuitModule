...
stuRtdbSvCircuit* RtdbClient::getSvCircuit(qulonglong code) const
{
	...
	if (circuitModel)
	{
		for (std::list<stuRtdbSvCircuit*>::const_iterator it = circuitModel->m_listSvCircuit.begin(); it != circuitModel->m_listSvCircuit.end(); ++it)
		{
...
stuRtdbGseCircuit* RtdbClient::getGseCircuit(qulonglong code) const
{
	...
	if (circuitModel)
	{
		for (std::list<stuRtdbGseCircuit*>::const_iterator it = circuitModel->m_listGseCircuit.begin(); it != circuitModel->m_listGseCircuit.end(); ++it)
		{
...
stuRtdbRealCircuit* RtdbClient::getRealCircuit(qulonglong code) const
{
	...
	if (circuitModel)
	{
		for (std::list<stuRtdbRealCircuit*>::const_iterator it = circuitModel->m_listRealCircuit.begin(); it != circuitModel->m_listRealCircuit.end(); ++it)
		{
